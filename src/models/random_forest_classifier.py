...
class RandomForestClassifier:
    FEATURE_COLUMNS = ['indexed_start_name', 'is_member']
    NUM_TREES = 10
    ...
    def train_model(self, data):
        ...
        random_forest = RFC(labelCol='indexed_end_name', featuresCol='indexed_features', numTrees=self.NUM_TREES, maxBins=946)
